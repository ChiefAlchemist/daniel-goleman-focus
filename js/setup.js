...
setupCaption.c1 = '<a href="http://autd.co/iriHJ" target="_blank"><i class="fa fa-twitter-square"></i> ChiefAlchemist1</a>'; 
setupCaption.c2 = '<a href="http://autd.co/JWhZb" target="_blank"><i class="fa fa-facebook-square"></i> ChiefAlchemist</a>';
setupCaption.c3 = '<a href="http://autd.co/8FNyJ" target="_blank"><i class="fa fa-pinterest-square"></i> ChiefAlchemist</a>';
setupCaption.c4 = '<a href="http://autd.co/OlGu0" target="_blank"><i class="fa fa-globe"></i> ChiefAlchemist.com</a>';
